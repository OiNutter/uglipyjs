...
class UglipyJS:
	...
	def __init__(self, options = {}):
		...
		self._context = execjs.compile(open(UglipyJS.es5_fallback_path, "r").read().decode('utf8') + open(UglipyJS.source_path, "r").read().decode('utf-8'))
	...
	def compile(self,source):
		source = str(source) if isinstance(source,unicode) or isinstance(source,str) else source.read()
		...
		#for line in js:
		#	line = codecs.utf_8_decode(line.encode('utf8'))[0]
